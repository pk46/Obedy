import asyncio
from src.Restaurants.PivovarskeDomy import PivovarskeDomy
from src.Restaurants.Kobyla import Kobyla
from src.Restaurants.Ulva import Ulva
from src.Restaurants.SportCafe import SportCafe
